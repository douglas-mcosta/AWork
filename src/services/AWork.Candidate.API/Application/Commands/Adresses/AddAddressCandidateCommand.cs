...
{
    public class AddAddressCandidateCommand : Command
    {
        ...
        public AddAddressCandidateCommand(Guid id, Guid candidateId, Guid countryId, string zipCode, string district, string street, string number, string complement, string state, string city)
        {
            Id = id;
        ...
        {
            ValidationResult = new AddAddressCandidateCommandValidation().Validate(this);
            return ValidationResult.IsValid;
        }
    }

    public class AddAddressCandidateCommandValidation : AbstractValidator<AddAddressCandidateCommand>
    {

        public AddAddressCandidateCommandValidation()
        {
